    ...
    def collect_gesture(self, capture, ges, photo_num):
        ...
        while True:
            ...
            if video and count < photo_num:
                cv2.imencode('.jpg', Ges)[1].tofile(self.train_path + str(ges) + '/' + '{}_{}.jpg'.format(str(random.randrange(1000, 100000)), str(ges)))
                count += 1
                print(count)
                ...
                cv2.imencode('.jpg', Ges)[1].tofile(self.predict_path + str(ges) + '/' + '{}_{}.jpg'.format(str(random.randrange(1000, 100000)), str(ges)))
                count += 1
                print(count)
